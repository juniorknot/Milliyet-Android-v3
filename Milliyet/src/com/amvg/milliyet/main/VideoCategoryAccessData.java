...
public class VideoCategoryAccessData extends AsyncTask<String, String, String>{
	...
	public VideoCategoryAccessData(Context context, ListView lv, String categoryName, String categoryID, String ActivityName, Context contextDialog){
		this.global=new Global();
		this.context=context;
		this.listview=lv;
		this.dirName="/sdcard/Milliyet/videocategory";
		this.pathName="http://mw.milliyet.com.tr/ashx/Milliyet.ashx?aType=MobileAPI_"+ActivityName+"VideoClips&CategoryID="+categoryID+"&PageIndex=0&PageSize=10";
	...
	private void fillListView(){
		...
		VideoCategoryAdapter adapter=new VideoCategoryAdapter(this.context,array, values, ActivityName, ContextDialog);
