...
public final class SkorerFragment extends Fragment 
{
    ...
    public static SkorerFragment newInstance(ArrayList<DataModelHomeHeadlines> results, int position, Context context, Context contextDialog) 
    {
    	appMap=new AppMap(context,contextDialog);
    	results_array=results;
        SkorerFragment fragment = new SkorerFragment();
