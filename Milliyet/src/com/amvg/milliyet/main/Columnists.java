...
public class Columnists extends FragmentActivity implements AnimationListener
{
	...
	@Override
	  public void onStart() {
	    super.onStart();
	    Log.e("Say","Columnists");
	    mGaTracker.sendView("Columnists");
	    mGaTrackerGlobal.sendView("Columnists");
