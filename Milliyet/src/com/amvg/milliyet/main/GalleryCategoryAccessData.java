...
public class GalleryCategoryAccessData extends AsyncTask<String, String, String>{
	...
	public GalleryCategoryAccessData(Context context, ListView lv, String categoryName, String categoryID, String isVideo, Context contextDialog){
		this.global=new Global();
		this.context=context;
		this.listview=lv;
		this.dirName="/sdcard/Milliyet/gallerycategory";
		this.pathName="http://mw.milliyet.com.tr/ashx/Milliyet.ashx?aType=MobileAPI_PhotoGalleriesByCategory&CategoryID="+categoryID+"&PageIndex=0&PageSize=10";
