...
public class ColumnistsAccessData extends AsyncTask<String, String, String>
{
	...
	public ColumnistsAccessData(Context context, ListView lv, int kont)
	{
		...
		if (this.kont==0) 
		{
			this.dirName="/sdcard/Milliyet/columnists";
			this.pathName="http://mw.milliyet.com.tr/ashx/Milliyet.ashx?aType=MobileAPI_Columnists";
			this.fileName=this.dirName+"/columnists.txt";
		}
		else
		{
			this.dirName="/sdcard/Milliyet/columnistsother";
			this.pathName="http://mw.milliyet.com.tr/ashx/Milliyet.ashx?aType=MobileAPI_ColumnistsOthers";
			this.fileName=this.dirName+"/columnists.txt";
		}
	}
	...
	private String[][] parseData(String JsonString) throws JSONException
	{
		...
		dataSayisi=results.size()+2-this.kont;
		...
		{
			values[0][0]="Yazarlar";
			values[k][0]="diğer yazarlar";
			k++;
		}
		else
		{
			values[0][0]="Diğer Yazarlar";
		}
		return values;
	}
	...
	private void fillListView()
	{
		...
		ColumnistsAdapter adapter=new ColumnistsAdapter(this.context,array, values,this.kont);
